...
(function($) {
	...
	Calendar.prototype._calculate_hour_minutes = function(data) {
		...
		if(!/^\d+$/.exec(data.in_hour) || this.options.time_split > 60) {
	...
	Calendar.prototype._first_day = function(){
		return getExtentedOption(this, 'first_day');
	}
	...
	Calendar.prototype._month = function(month) {
		...
		t.month_name = this.locale['m' + month].substring(0,3);
	...
	Calendar.prototype._loadEvents = function() {
		if (!loaded){		
					...
					if(source.length) {
						loader = function() {
							...
							for (var i=0;i<events.length;i++){
								events[i].style = 'background-color : rgb('+r+','+g+','+b+')';
								events[i].style_dim = 'background-color : rgb('+r*2/3+','+g*2/3+','+b*2/3+')';
								
								if (r+g+b<=255){
									events[i].style_dim = events[i].style_dim+';color : white';
								}
								switch (''+r+g+b){
								case '255255255': b=0; 					break;		
								case '2552550' 	: g=0; b=255; 			break;		
								case '2550255'	: b=0; 					break;		
								case '25500'	: r=0; g=255; b=255; 	break;		
								case '0255255'	: b=0; 					break;		
								case '02550'	: g=0; b=255;			break;		
								case '00255'	: b=0; 					break;
								case '000' 		: r=255; g= 255; b=255;	break;		
								}
							}
							return events;
						};
			...
			events_loaded=self.options.events;
			loaded=true;
		} else {
				...
				modal
					.on('show.bs.modal', function() {
						...
						switch(self.options.modal_type) {
							case "iframe" :
								var height = modal_body.height() - parseInt(modal_body.css('padding-top'), 10) - parseInt(modal_body.css('padding-bottom'), 10)/2;
