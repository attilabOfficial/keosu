...
************************************************************************/
namespace Keosu\Gadget\PicturesGalleryGadgetBundle;
...
class PicturesGalleryGadget extends GadgetParent implements iGadget {
	...
	public function getGadgetName() {
		return "pictures_gallery_gadget";
	}
	...
	public static function constructfromGadget($gadget) {
		...
		$instance->picturesPerPage = $gadgetConfig['pictures-per-page'];
		return $instance;
	}
	...
	public function getAsCommonGadget() {
		...
		if ($this->picturesPerPage != null) {
			$config = array();
			$config['articles-per-page'] = $this->articlesPerPage;
	...
	public function convertAsExistingCommonGadget($commonGadget) {
		...
		if ($this->picturesPerPage != null) {
			$config = array();
			$config['pictures-per-page'] = $this->picturesPerPage;
			$commonGadget->setConfig($config);
		}
	}
	...
	public function setPicturesPerPage($picturesPerPage) {
		$this->picturesPerPage = $picturesPerPage;
	}
