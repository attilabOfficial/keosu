...
************************************************************************/
namespace Keosu\Gadget\LastArticleGadgetBundle;
...
class LastArticleGadget extends GadgetParent implements iGadget {
	...
	public static function constructfromGadget($gadget) {
		...
		$instance->articlesPerPage = $gadgetConfig['articles-per-page'];
		return $instance;
	}
